      ...
      <div class="flex items-start sm:items-center space-x-3 min-w-0">
        ...
        <div class="min-w-0">
          <div class="flex items-center space-x-2 flex-wrap gap-y-1">
            ...
            <span class="text-[10px] sm:text-xs bg-amber-200/80 text-amber-900 px-2 py-0.5 rounded-full font-semibold">续保提醒</span>
          </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
      <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm relative overflow-hidden">
        ...
        <div class="mt-2 flex items-baseline space-x-2">
          <span class="text-xl sm:text-2xl font-bold text-slate-900">{{ vehicleTotalCount }}</span>
        ...
        <div class="absolute right-3 -bottom-2 text-sky-50/70 sm:text-sky-50 text-5xl sm:text-6xl pointer-events-none">
      ...
      <div class="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm relative overflow-hidden">
        ...
        <div class="mt-2 flex items-baseline space-x-2">
          <span class="text-xl sm:text-2xl font-bold text-slate-900">¥{{ formatMoney(totalVehiclePremium) }}</span>
        ...
        <div class="absolute right-3 -bottom-2 text-emerald-50/70 sm:text-emerald-50 text-5xl sm:text-6xl pointer-events-none">
