<template>
  <div>
    ...
    <div
      v-if="unpaidCount > 0"
      class="p-4 rounded-2xl bg-gradient-to-r from-rose-50 to-amber-50 border border-rose-200/80 shadow-sm flex flex-wrap items-center justify-between gap-3"
    >
      <div class="flex items-center space-x-3">
        <div class="w-10 h-10 rounded-xl bg-rose-500 text-white flex items-center justify-center text-lg shadow-md shadow-rose-200 animate-pulse">
          <i class="fa-solid fa-triangle-exclamation"></i>
        </div>
        <div>
          <div class="flex items-center space-x-2">
            <h4 class="text-sm font-bold text-rose-950">
              注意：发现 {{ unpaidCount }} 笔保单保费扣款异常 / 待跟进
            </h4>
            <span class="text-xs bg-rose-200/80 text-rose-900 px-2 py-0.5 rounded-full font-semibold">扣费异常</span>
          </div>
      ...
      <button
        ...
        class="px-4 py-2 bg-rose-600 hover:bg-rose-700 active:bg-rose-800 text-white text-xs font-semibold rounded-xl shadow-sm transition flex items-center space-x-1.5 cursor-pointer"
      >
        <span>前往查看异常保费</span>
      ...
      <div class="flex items-center space-x-3">
        ...
        <div>
          <div class="flex items-center space-x-2">
            ...
            <span class="text-xs bg-amber-200/80 text-amber-900 px-2 py-0.5 rounded-full font-semibold">续保预警</span>
          </div>
    ...
    <div
      ...
      class="p-4 rounded-2xl bg-gradient-to-r from-sky-50 to-indigo-50 border border-sky-200/80 shadow-sm flex flex-wrap items-center justify-between gap-3"
    >
      <div class="flex items-center space-x-3">
        <div class="w-10 h-10 rounded-xl bg-sky-500 text-white flex items-center justify-center text-lg shadow-md shadow-sky-200">
        ...
        <div>
          <div class="flex items-center space-x-2">
            ...
            <span class="text-xs bg-sky-200/70 text-sky-800 px-2 py-0.5 rounded-full font-semibold">银行自动扣缴</span>
          </div>
      ...
      <button
        ...
        class="px-4 py-2 bg-sky-600 hover:bg-sky-700 active:bg-sky-800 text-white text-xs font-semibold rounded-xl shadow-sm transition flex items-center space-x-1.5 cursor-pointer"
      >
        <span>查看扣费日历</span>
